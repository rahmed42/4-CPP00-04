...
/*   Updated: 2022/06/07 17:17:05 by rahmed           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	std::cout << "\033[1;33mClapTrap getName called\033[0m" << std::endl;
	return (this->_name);
}

int	ClapTrap::getHitPoints(void)
{
	std::cout << "\033[1;33mClapTrap getHitPoints called\033[0m" << std::endl;
	return (this->_hitPoints);
}

void	ClapTrap::setHitPoints( int hitPoints )
{
	std::cout << "\033[1;33mClapTrap setHitPoints called\033[0m" << std::endl;
	this->_hitPoints = hitPoints;
}

int	ClapTrap::getEnergyPoints(void)
{
	std::cout << "\033[1;33mClapTrap getEnergyPoints called\033[0m" << std::endl;
	return (this->_energyPoints);
}

void	ClapTrap::setEnergyPoints( int energyPoints )
{
	std::cout << "\033[1;33mClapTrap setEnergyPoints called\033[0m" << std::endl;
	this->_energyPoints = energyPoints;
}

unsigned int	ClapTrap::getAttackDamage(void)
{
	std::cout << "\033[1;33mClapTrap getAttackDamage called\033[0m" << std::endl;
	return (this->_attackDamage);
}

void	ClapTrap::setAttackDamage(unsigned int attackDamage)
{
	std::cout << "\033[1;33mClapTrap setAttackDamage called\033[0m" << std::endl;
